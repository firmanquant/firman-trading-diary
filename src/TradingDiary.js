  ...
  return (
    <div className="container">
      ...
      <div className="main-dashboard">
        <div className="groq-analysis-box">
          <h3>Analisis Groq:</h3>
          <p>{groqAnalysis}</p>
        </div>
      ...
      <div className="summary-dashboard-container">
        ...
        <div className="summary-card"><h2>Gain/Loss</h2><p style={{ color: stats.gain >= 0 ? 'lime' : 'red' }}>{stats.gain >= 0 ? '+' : ''}{stats.gain.toFixed(2)}</p></div>
      </div>
          ...
          <tbody>
            {entries.map((e, i) => (
              <tr key={i}>
                ...
                <td style={{ color: e.exit - e.entry >= 0 ? 'lime' : 'red' }}>{(e.exit - e.entry).toFixed(2)}</td>
                <td>{e.reason}</td>
                <td>{e.emotion}</td>
